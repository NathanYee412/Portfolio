    ...
    return(
        <div className='flex h-screen bg-cover bg-slate-800 pl-8 pr-8'>
            <div className='flex container justify-center md:m-40'>
                <div className='md:columns-2 gap-1 max-w-screen-xl'>
                    <div className='flex justify-center'>
                        <div className='text-center sm:text-left lg:text-left pl-8 pb-8 pr-8'>
                            ...
                            {/* <div className='pt-2'>
                                <button className='bg-[#575bfb] text-[#fbff00] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>View Projects</button>
                                <button className='bg-[#575bfb] text-[#fbff00] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full'>Contact Me</button>
                            </div> */}
                        </div>
                    </div>    
